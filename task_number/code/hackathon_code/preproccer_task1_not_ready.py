...
def preprocess_train_task1(path, with_dummies):
    df = pd.read_csv(path)
...
def load_train_data_task1(with_dummies):
    DATA_PATH = "./hackathon_code/data/train.csv"
    return preprocess_train_task1(DATA_PATH, with_dummies)
...
def load_train_agoda_data_task1(with_dummies):
